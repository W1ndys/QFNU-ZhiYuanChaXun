...
<html>
  <head>
    ...
    <title>QFNU of W1ndys-志愿查询</title>
  </head>
  <body>
    <div id="app">
      <h1>曲阜师范大学志愿查询</h1>
      <p>此页面查询结果仅供参考，请勿过度依赖此页面结果，理性填报，<em>对口专业仅有分数参考价值</em>，数据来源于：<a href="https://zs.xynu.edu.cn/lnsj.htm">曲阜师范大学2023级录取情况</a></p>
      ...
      <h2>接近排名的专业</h2>
        ...
        <el-image style="width: 400px; height: 400px" src="https://download.easy-qfnu.top/upload/fcb433e892924f3282c7a96638c77743.png"></el-image>
        <p>Run by <a href="https://www.easy-qfnu.top/">SfTian</a> 任何意见整改请发送邮件到 <a href="mailto://xibotian@xynu.edu.cn">xibotian@xynu.edu.cn</a></p>
    ...
    <script>
      const App = {
        ...
        methods: {
            getProvince() {
                fetch("https://act.easy-qfnu.top/index.php?type=area")
            ...
            getMajor() {
                fetch("https://act.easy-qfnu.top/index.php?type=area&province=" + this.form.province)
                .then((response) => response.json())
                .then((data) => {
                    this.majorList = data;
            ...
            getRank() {
                fetch(
                "https://act.easy-qfnu.top/index.php?type=rank&province=" +
                    this.form.province +
                    "&major=" +
                    this.form.major
                )
